    ...
    <div>
      <Layout title="Sign up | Overpay">
        <div className="flex items-center justify-between">
            <div className="bg-primary-base h-[976px] w-[639px] text-grayscale-50 ml-6">
                <div className="absolute z-10 ml-4 mt-4">
                    <Image src="/images/logo-white.png" height={32} width={149} alt="logo" />
                </div>
            ...
            <div className="w-full h-full min-h-[1024px]">
                ...
                <h1 className="text-3xl font-extrabold leading-10 text-center text-grayscale-900">Sign up to Overpay</h1>
